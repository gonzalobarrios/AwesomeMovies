...
import com.example.awesomemovies.model.MoviesGridItem
...
import kotlinx.android.synthetic.main.principal_grid_item.view.*

class MainAdapter: BaseAdapter {
    var list = ArrayList<MoviesGridItem>()
    var context: Context? = null

    constructor(context: Context, items: ArrayList<MoviesGridItem>) : super() {
